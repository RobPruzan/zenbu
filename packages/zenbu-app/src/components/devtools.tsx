...
export default function DevTools({ onClose }: DevToolsProps) {
  ...
  return (
    <div className="relative flex h-full flex-col overflow-hidden bg-[#151515]">
      {/* Background gradients (matching chat interface) */}
      <div className="absolute inset-0 z-0 overflow-hidden">
        <div className="absolute left-[-30%] top-[-50%] h-[100%] w-[100%] bg-gradient-to-br from-slate-800/20 via-slate-800/5 to-transparent opacity-30 blur-[150px]"></div>
        <div className="absolute bottom-[-30%] right-[-20%] h-[80%] w-[100%] bg-gradient-to-tl from-slate-700/10 via-slate-700/5 to-transparent opacity-20 blur-[180px]"></div>
        <div className="absolute right-[5%] top-[10%] h-[50%] w-[50%] bg-gradient-to-bl from-indigo-800/5 via-slate-700/5 to-transparent opacity-10 blur-[120px]"></div>
      ...
      >
        ...
        <div className="flex items-center border-b border-[#323236] bg-[#1d1d1f]">
          {/* Left side - tab navigation */}
          <div className="flex flex-1 items-center">
            <TabsList className="h-9 justify-start rounded-none border-0 bg-transparent p-0">
              <TabsTrigger
                value="console"
                className="h-9 rounded-none px-3 text-[11px] font-medium text-[#bbbbbd] data-[state=active]:bg-[#262628] data-[state=active]:text-white data-[state=active]:shadow-none"
              >
          ...
          <div className="flex h-9 items-center gap-1 px-2">
            ...
            <Button
              variant="ghost"
              size="sm"
              className="flex h-7 w-7 items-center justify-center rounded-md p-0 text-[#bbbbbd] hover:bg-[#323236] hover:text-white"
              onClick={onClose}
            >
              <X className="h-4 w-4" />
            </Button>
        ...
        <TabsContent value="console" className="m-0 flex-1 border-0 p-0">
          <div className="flex h-full flex-col">
            <div className="flex items-center justify-between border-b border-[#323236] bg-[#1d1d1f] px-2 py-1">
              <div className="flex items-center gap-1.5">
                <Button
                  variant="ghost"
                  size="sm"
                  className="h-7 px-2.5 text-[11px] text-[#bbbbbd] hover:bg-[#323236] hover:text-white"
                ...
                <div className="ml-2 flex items-center gap-1.5">
                  <button
                    ...
                    className={`rounded px-2 py-0.5 text-[11px] ${consoleFilters.errors ? "border border-red-500/30 bg-red-500/20 text-red-400" : "border border-[#323236] bg-[#262628] text-[#bbbbbd]"}`}
                  >
                    Errors
                  </button>
                  <button
                    ...
                    className={`rounded px-2 py-0.5 text-[11px] ${consoleFilters.warnings ? "border border-amber-500/30 bg-amber-500/20 text-amber-400" : "border border-[#323236] bg-[#262628] text-[#bbbbbd]"}`}
                  >
                    Warnings
                  </button>
                  <button
                    ...
                    className={`rounded px-2 py-0.5 text-[11px] ${consoleFilters.logs ? "border border-blue-500/30 bg-blue-500/20 text-blue-400" : "border border-[#323236] bg-[#262628] text-[#bbbbbd]"}`}
                  >
                    Logs
                  </button>
                  <button
                    ...
                    className={`rounded px-2 py-0.5 text-[11px] ${consoleFilters.info ? "border border-green-500/30 bg-green-500/20 text-green-400" : "border border-[#323236] bg-[#262628] text-[#bbbbbd]"}`}
                  >
                    Info
                  </button>
                </div>
              ...
              <div className="relative w-[200px]">
                ...
                <Input
                  ...
                  className="h-7 rounded border-[#323236] bg-[#262628] pl-8 text-[11px] text-white placeholder:text-[#808085] focus-visible:ring-1 focus-visible:ring-[#4f4f52] focus-visible:ring-offset-0"
                />
              </div>
            </div>
              ...
              <div className="p-0 font-mono text-[12px]">
                {filteredLogs.length === 0 ? (
                  ...
                  filteredLogs.map((log) => (
                    <div
                      key={log.id}
                      className={`group flex items-start border-b border-[#323236] px-3 py-2 ${
                        log.type === "error"
                    ...
                    >
                      ...
                      {(log.type === "error" || log.type === "warning") && (
                        <button
                          className="flex items-center rounded border border-blue-500/20 bg-blue-500/10 px-2 py-0.5 text-[10px] text-blue-400 opacity-0 transition-opacity group-hover:opacity-100"
            ...
            <div className="border-t border-[#323236] p-2">
              <form onSubmit={handleConsoleSubmit} className="flex gap-2">
                <Input
                  ...
                  className="h-8 border-[#323236] bg-[#262628] text-[12px] text-white placeholder:text-[#808085] focus-visible:ring-1 focus-visible:ring-[#4f4f52] focus-visible:ring-offset-0"
                />
                <Button
                  type="submit"
                  variant="outline"
                  size="sm"
                  className="h-8 border-[#323236] bg-[#262628] px-3 text-[11px] text-white hover:bg-[#323236] hover:text-white"
                >
                  Run
                </Button>
              </form>
          ...
          <div className="flex h-full flex-col">
            ...
            <div className="flex-1 overflow-auto">
              {networkRequests.length === 0 ? (
                <div className="p-3 text-center text-[12px] text-[#808085]">
                      ...
                      className={`rounded-md p-2.5 ${
                        request.status >= 400
                          ...
                          : request.status >= 300
                            ...
                            : "border border-[#323236] bg-[#1d1d1f]"
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="max-w-[200px] truncate text-[11px] font-medium text-white">
                            {request.url}
                          </span>
                        </div>
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-[10px] text-[#bbbbbd]">
                            {request.duration}
                          </span>
                        </div>
                      </div>
                      ...
                      {request.status >= 400 && (
                        <div className="mt-2 rounded border border-[#323236] bg-[#1a1a1c] p-2 text-[11px] text-red-400">
                          Error:{" "}
                          {request.status === 404
                            ? "Resource not found"
                            : "Server error"}
        ...
        <TabsContent value="performance" className="m-0 flex-1 border-0 p-0">
          <div className="flex h-full">
            ...
            <div className="w-[30%] border-r border-[#323236]">
              <div className="flex items-center justify-between border-b border-[#323236] bg-[#1d1d1f] px-3 py-1.5">
                ...
                <Button
                  variant="ghost"
                  size="sm"
                  className="h-7 w-7 rounded-md p-0 text-[#bbbbbd] hover:bg-[#323236] hover:text-white"
                >
              ...
              <ScrollArea className="h-[calc(100%-32px)]">
                <div className="space-y-0">
                  {performanceData.interactions.map((interaction) => (
                    <div
                      key={interaction.id}
                      className="flex cursor-pointer items-center border-b border-[#323236] px-3 py-2 hover:bg-[#262628]"
                    >
            ...
            <div className="flex-1">
              <div className="flex items-center justify-between border-b border-[#323236] bg-[#1d1d1f] px-3 py-1.5">
                ...
                <div className="flex items-center gap-1.5">
                  ...
                  <select className="h-6 rounded border-[#323236] bg-[#262628] px-2 text-[10px] text-white focus-visible:ring-1 focus-visible:ring-[#4f4f52] focus-visible:ring-offset-0">
              ...
              <ScrollArea className="h-[calc(100%-32px)]">
                <div className="space-y-1.5 p-2">
                  {performanceData.components.map((component, index) => (
                    <div
                      key={index}
                      className="group rounded-md border border-[#323236] bg-[#1d1d1f] p-2.5 hover:bg-[#262628]"
                    >
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <span className="text-[11px] font-medium text-white">
                          ...
                          <span className="rounded-full border border-[#323236] bg-[#262628] px-2 py-0.5 text-[10px] text-[#bbbbbd]">
                            x{component.renders}
                          </span>
                        </div>
                      ...
                      <div className="mt-2">
                        <div className="mb-1 flex justify-between text-[10px] text-[#bbbbbd]">
                          <span>Render time (avg: {component.avgTime})</span>
                        </div>
                        <div className="h-1.5 w-full rounded-full bg-[#262628]">
                          <div
                            className={`${
                      ...
                      <div className="mt-2 text-right text-[10px]">
                        <button className="text-blue-400 opacity-0 transition-opacity group-hover:opacity-100">
                          View details
                        </button>
                      </div>
                    </div>
