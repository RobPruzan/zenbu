...
import { Send, Save, Play, ChevronDown, ArrowLeft, Copy, Code, Eye } from "lucide-react";
...
export function HttpClient({ onBack }: { onBack: () => void }) {
  ...
  const [tabs] = useState<Tab[]>([
    ...
    { id: "3", name: "Update Profile", method: "PUT", url: "https://api.example.com/users/1" },
  ]);
            ...
            {tabs.map((tab) => (
              ...
              >
                <div className={cn(
                  ...
                  tab.method === "PATCH" && "bg-purple-500/20 text-purple-500"
                )}>
                  {tab.method}
                </div>
