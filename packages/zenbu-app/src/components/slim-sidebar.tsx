...
export function SlimSidebar({ className }: SlimSidebarProps) {
  ...
  const handleReactTree = () => {
    window.dispatchEvent(new CustomEvent("toggle-react-tree", { detail: { position: "left" } }));
  };
  ...
  const handlePerformance = () => {
    actions.setRoute(state.activeRoute === "performance" ? "off" : "performance");
  };
  ...
  return (
    <TooltipProvider>
      <div className={cn("flex w-12 flex-col gap-1 border-r border-border/40 bg-background p-2", className)}>
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button variant="ghost" size="icon" className="h-8 w-8" onClick={handleReactTree}>
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button variant="ghost" size="icon" className="h-8 w-8" onClick={handleHttpClient}>
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button variant="ghost" size="icon" className="h-8 w-8" onClick={handleChat}>
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button variant="ghost" size="icon" className="h-8 w-8" onClick={handleBottomPanel}>
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button 
              variant="ghost" 
              size="icon" 
              className={cn("h-8 w-8", state.drawing.active && "bg-accent text-accent-foreground")} 
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button 
              variant="ghost" 
              size="icon" 
              className={cn("h-8 w-8", state.screenshotting.active && "bg-accent text-accent-foreground")} 
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button 
              variant="ghost" 
              size="icon" 
              className={cn("h-8 w-8", state.recording.active && "bg-accent text-accent-foreground")} 
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button 
              variant="ghost" 
              size="icon" 
              className={cn("h-8 w-8", inspector.state.kind === "inspecting" && "bg-accent text-accent-foreground")} 
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button 
              ...
              size="icon" 
              className="h-8 w-8"
              onClick={() => window.dispatchEvent(new Event("toggle-react-scan"))}
            >
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button 
              variant="ghost" 
              size="icon" 
              className={cn("h-8 w-8", state.activeRoute === "console" && "bg-accent text-accent-foreground")}
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button 
              variant="ghost" 
              size="icon" 
              className={cn("h-8 w-8", state.activeRoute === "network" && "bg-accent text-accent-foreground")}
        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button 
              variant="ghost" 
              size="icon" 
              className={cn("h-8 w-8", state.activeRoute === "performance" && "bg-accent text-accent-foreground")}
